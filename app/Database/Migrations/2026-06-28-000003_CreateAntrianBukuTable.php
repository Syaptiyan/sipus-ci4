...
class CreateAntrianBukuTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'nomor_antrian' => ['type' => 'INT', 'constraint' => 11],
        ...
        $this->forge->createTable('antrian_buku');
    }

    public function down()
    {
        $this->forge->dropTable('antrian_buku');
    }
}
